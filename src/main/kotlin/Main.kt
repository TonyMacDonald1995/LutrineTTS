...
private val logger = LoggerFactory.getLogger("LutrineTTS")
...
fun main() {
    ...
    logger.info("Starting LutrineTTS v2.0.0")

    val storage = Storage(dataDir)
    val ttsService = TtsService(openAiToken)
    val bot = Bot(discordToken, storage, ttsService)
